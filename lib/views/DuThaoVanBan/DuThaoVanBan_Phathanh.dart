...
class MyDuThaoVanBanPhatHanh extends StatefulWidget {
  final int id;
  MyDuThaoVanBanPhatHanh({@required this.id});

  @override
  _MyDuThaoVanBanPhatHanh createState() => new _MyDuThaoVanBanPhatHanh();
}
...
class _MyDuThaoVanBanPhatHanh extends State<MyDuThaoVanBanPhatHanh> {
  ...
  void _clicktrinhld() {
    if ((_noidung == null || (_noidung.text.length <= 0))) {
      ...
      PhatHanhEvent yKienEvent = new PhatHanhEvent();
