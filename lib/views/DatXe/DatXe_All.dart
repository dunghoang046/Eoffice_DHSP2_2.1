...
class MyDatXeAllpage extends StatefulWidget {
  ...
  DatXeblock requestblock;
  MyDatXeAllpage({this.requestkeyword, this.requestblock});
  _MyDatXeAllpage createState() => _MyDatXeAllpage();
}

String keyword = '';
bool inter = true;

class _MyDatXeAllpage extends State<MyDatXeAllpage>
  ...
  void didChangeDependencies() {
    ...
    widget.requestblock = Provider.of<DatXeblock>(context);
  }
        ...
        child: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              ...
              if (snapshot.hasData && snapshot.data) {
                return BlocBuilder<BlocDatXeAction, ActionState>(
