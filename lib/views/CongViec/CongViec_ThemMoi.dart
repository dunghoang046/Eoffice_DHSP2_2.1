  ...
  void _click_add() {
    if (_formKeyadd.currentState.validate()) {
      var data = {
        ...
        "strUserPerform": lstnguoidungthuchien.toSet().toList(),
        "strUserFollow": lstnguoidungtheodoi.toSet().toList(),
  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      DateTimeField(
        ...
        initialValue: objcvadd.endDate != null
            ? DateTime.parse(objcvadd.endDate)
            : DateTime.now(),
